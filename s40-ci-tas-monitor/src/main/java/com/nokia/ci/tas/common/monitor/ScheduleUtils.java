...
public class ScheduleUtils {
	public static String SCHEDULE_GROUP_NAME = "tas_monitor_schedule_group";
	 ...
	 */
	public static synchronized void scheduleIntervalJob( String scheduleName, Class<? extends Job> jobClass, IntervalUnit unit, int intervalCnt, Date triggerStartTime ) {
		try {
			if ( scheduler != null ) {
			...
			System.err.println( "Schedule a new job failed, scheduleName=" + scheduleName );
			e.printStackTrace();
		}
	}
